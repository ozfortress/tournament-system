module Tournament
  module PagePlayoff
    ...
    def generate(driver, options = {})
      ...
      when 1 then preliminary_finals(driver, teams)
      when 2 then grand_finals(driver, teams, options)
      else
    ...
    def preliminary_finals(driver, teams)
    ...
    def grand_finals(driver, teams, options)
      matches = driver.matches
      ...
      bronze_finals(driver, teams, matches) if options[:bronze_match]
    end

    def bronze_finals(driver, teams, matches)
