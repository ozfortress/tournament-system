...
require 'tournament-system/algorithm/matching'
require 'tournament-system/algorithm/group_pairing'
...
module TournamentSystem
  module Swiss
    ...
    module Dutch
      ...
      #
      # Teams are initially grouped by their score and then slide paired ({TournamentSystem::Algorithm::GroupPairing.slide}).
